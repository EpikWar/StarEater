        ...
        try //Instantiate s1
        {
            for (int i = 0; i < gunPointS1.Length; i++){
                if (shipData.LoadShip().IDWeaponS1[i] != -1) //if "-1" - dont Instantiate and go next
                    foreach (ScriptableWeapon weapon in weaponS1)
        ...
        try //Instantiate s2
        {
            for (int i = 0; i < gunPointS2.Length; i++)
                if (shipData.LoadShip().IDWeaponS2[i] != -1) //if "-1" - dont Instantiate and go next
                    foreach (ScriptableWeapon weapon in weaponS2)
        ...
        try //Instantiate s4
        {
            for (int i = 0; i < gunPointS4.Length; i++)
                if (shipData.LoadShip().IDWeaponS4[i] != -1) //if "-1" - dont Instantiate and go next
                    foreach (ScriptableWeapon weapon in weaponS4)
